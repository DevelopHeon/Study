package com.uni.khh.chap09.hw1.run;

import com.uni.khh.chap09.hw1.model.vo.Employee;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<emp.length; i++) { // 직원들의 연봉을 구해서 tSal 변수에 담는다.
			int tSal = (int)(emp[i].getSalary() + (emp[i].getSalary() * emp[i].getBonusPoint()))* 12;
			
			System.out.println(emp[i].getEmpName() + "의 연봉 : " + tSal);
			
			sumSal += tSal/3;
		}
		
		System.out.println("====================================");
		System.out.println("직원들의 연봉의 평균 : " + sumSal);
	}
}
