...
public class Ex14_10 {
	...
	public static void main(String[] args) {
		Student2[] stuArr = {
				...
				new Student2("김지미", true, 1, 1, 200),
				new Student2("홍길동", false, 1, 2, 150),
				new Student2("김개똥", true, 1, 2, 100),
				new Student2("안지미", false, 1, 2, 50),
				new Student2("박지미", false, 1, 3, 100),
				new Student2("효지미", false, 1, 3, 150),
				new Student2("지지미", true, 1, 3, 200),
				new Student2("이말년", true, 2, 1, 300),
				new Student2("홍자바", false, 2, 1, 250),
				new Student2("표자바", true, 2, 1, 200),
				new Student2("진자바", false, 2, 2, 150),
				new Student2("제갈자바", false, 2, 2, 100),
				new Student2("남궁자바", false, 2, 2, 50),
				new Student2("강자바", true, 2, 3, 100),
				new Student2("이자바", false, 2, 3, 150),
				new Student2("손자바", true, 2, 3, 200)
		};
